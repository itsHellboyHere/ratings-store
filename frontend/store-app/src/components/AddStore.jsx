...
const AddStore = () => {
    ...
    return (
        <main className='max-w-md mx-auto p-10 '>
            <h3 className='text-xl font-bold mb-4 text-gray-600 text-center'>Create Store</h3>
            {error && <p className="text-red-600">{error}</p>}
            <div className="flex w-full rounded-sm justify-center items-center mt-10 p-4"
                style={{
